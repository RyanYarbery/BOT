...
class TimeSeriesDataset(torch.utils.data.Dataset):
    ...
    def get_valid_indices(self, valid_indices):
        ...
        last_index = (len(valid_indices) - self.data.future_ticks ) - ((len(valid_indices) - self.data.future_ticks -1) % config['training']['batch_size']) - 1 # This -1 is important, idk... but it is.
